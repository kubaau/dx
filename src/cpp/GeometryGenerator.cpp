...
void GeometryGenerator::Subdivide(MeshData& meshData)
{
    ...
    unsigned numTris = static_cast<unsigned>(inputCopy.Indices.size()) / 3;
...
void GeometryGenerator::CreateGeosphere(float radius, unsigned numSubdivisions, MeshData& meshData)
{
    ...
    for (unsigned i = 0; i < meshData.Vertices.size(); ++i)
    {
...
void GeometryGenerator::BuildCylinderTopCap(
    float, float topRadius, float height, unsigned sliceCount, unsigned, MeshData& meshData)
{
...
void GeometryGenerator::BuildCylinderBottomCap(
    float bottomRadius, float, float height, unsigned sliceCount, unsigned, MeshData& meshData)
{
    //
    // Build bottom cap.
    //
